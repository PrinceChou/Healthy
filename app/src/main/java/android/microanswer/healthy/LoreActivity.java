...
public class LoreActivity extends BaseActivity implements View.OnClickListener {
        ...
        runOnOtherThread(new BaseOtherThread() {
            ...
            void onOtherThreadRunEnd(Message msg) {
                if (msg != null) {
                    ...
                    TextView ttitle = new TextView(LoreActivity.this);
                    ttitle.setText("总共" + pinLuns.size() + "条评论");
                    int i = BaseTools.Dp2Px(LoreActivity.this, 7f);
                    ...
                    for (PinLun pinLun : pinLuns) {
                        View v = View.inflate(LoreActivity.this, R.layout.view_pinlun_item, null);
            ...
            public Map getTaskParams() {
                ...
                p.put("id", loreListItem.getId());
                p.put("type", TYPE_LORE);
                return p;
            }
